...
//20141031因为主机没有做最后一版，所以主机还是用P1^5来通讯的
//20171014 做的新主机，P1.5连了电路，需只读屏蔽，仍然用P3.2完成发送和接收
//20171014 原来P3.2设置成强推挽，所P3.2在发送数据时的作用是拉低，设置成开漏更合理，而且只有设置成开漏才能正常工作。
//20171014 原来用P1.5来拉低，通过三极管拉低，确实要设置成强推挽
